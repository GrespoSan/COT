...
MERCATI = {
    ...
    "S&P 500 E-mini (CME) TFF": ("S&P 500 Consolidated - CHICAGO MERCANTILE EXCHANGE", "TFF"),
    "Nasdaq 100 E-mini (CME) LEGACY": ("NASDAQ MINI - CHICAGO MERCANTILE EXCHANGE", "LEGACY"),
