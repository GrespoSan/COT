...
# =============================================================================
st.set_page_config(
    page_title="COT Smart Money V6.5 — Python",
    page_icon="🛡️",
    layout="wide",
)
...
st.title("🛡️ COT Smart Money — Python V6.5")
st.caption(
...
def build_screener_excel(results: pd.DataFrame, errors: pd.DataFrame) -> bytes:
    ...
    display_columns = [
        ...
        "COT Index", "Alignment rialzista", "Alignment ribassista", "Rapid Shift 6W",
...
def build_screener_ai_prompt(top_rows: pd.DataFrame, top_n: int) -> str:
    ...
    compact_columns = [
        ...
        "COT Index", "Flow 1W", "Flow 3W", "Flow 6W", "Rapid Shift 6W", "Stato Rapid Shift",
