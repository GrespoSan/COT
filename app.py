...
MERCATI = {
    ...
    "Petrolio WTI": ("WTI-PHYSICAL - NEW YORK MERCANTILE EXCHANGE", "LEGACY"),
    "GASOLINE (RBOB)": ("GASOLINE RBOB - NEW YORK MERCANTILE EXCHANGE", "LEGACY"),
    ...
    "Palladium": ("PALLADIUM - NEW YORK MERCANTILE EXCHANGE", "LEGACY"),
    "Platino": ("PLATINUM - NEW YORK MERCANTILE EXCHANGE", "LEGACY"),
